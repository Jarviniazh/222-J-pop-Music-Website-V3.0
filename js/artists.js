...
window.artists = [
  {
    ...
    urls: [
      ...
      { url: "https://open.spotify.com/artist/2XMxWKPKCxoLkSdpCViCnr", name: "Spotify" },
  ...
  },
  {
    ...
    urls: [
      ...
      { url: "https://open.spotify.com/artist/1XYuC1vxinTjHCNd5clB8C", name: "Spotify" }
    ]
  },
  {
    artistId: "AID-5",
    ...
    urls: [
      ...
      { url: "https://www.instagram.com/k_kamenashi_23/?hl=en", name: "Instagram" },
      { url: "https://www.storm-labels.co.jp/s/js/artist/J0006?wovn=en&ima=2435", name: "J Storm" },
      { url: "https://open.spotify.com/artist/5HQAzIHOdemXR2DoevwhjT", name: "Spotify" }
    ]
  }
];
